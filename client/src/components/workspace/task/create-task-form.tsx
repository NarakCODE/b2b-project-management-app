...
import {
  TaskTypeRequestSchema,
  TaskTypeRequestSchemaType,
} from '@/lib/validators';
...
export default function CreateTaskForm(props: {
  ...
  const { data: memberOptions } = useGetWorkspaceMembers(workspaceId);
  ...
  const form = useForm<TaskTypeRequestSchemaType>({
    resolver: zodResolver(TaskTypeRequestSchema),
    defaultValues: {
      title: '',
      description: '',
  ...
  const onSubmit = (values: TaskTypeRequestSchemaType) => {
    const payload = {
      workspaceId,
      projectId: projectId || '',
      data: {
    ...
    <div className='w-full h-auto max-w-full'>
      <div className='h-full'>
        <div className='mb-5 pb-2 border-b'>
          ...
          <p className='text-muted-foreg  round text-sm leading-tight'>
